...
#ifndef VILLAGE_INTERFACES__SRV__DETAIL__SELL_NOVEL__FUNCTIONS_H_
#define VILLAGE_INTERFACES__SRV__DETAIL__SELL_NOVEL__FUNCTIONS_H_
 ...
 * calls
 * village_interfaces__srv__SellNovel_Request__init().
...
/**
 * It calls
 * village_interfaces__srv__SellNovel_Request__fini()
 ...
 * village_interfaces__srv__SellNovel_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * village_interfaces__srv__SellNovel_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * village_interfaces__srv__SellNovel_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_village_interfaces
...
/**
 * It calls
 * village_interfaces__srv__SellNovel_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_village_interfaces
...
/**
 * It allocates the memory for the array and calls
 * village_interfaces__srv__SellNovel_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_village_interfaces
...
/**
 * It calls
 * village_interfaces__srv__SellNovel_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // VILLAGE_INTERFACES__SRV__DETAIL__SELL_NOVEL__FUNCTIONS_H_
