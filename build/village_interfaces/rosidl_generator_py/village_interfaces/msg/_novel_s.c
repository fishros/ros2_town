...
bool village_interfaces__msg__novel__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("village_interfaces.msg._novel.Novel", full_classname_dest, 35) == 0);
  }
  village_interfaces__msg__Novel * ros_message = _ros_message;
  {  // content
...
{
  /* NOTE(esteve): Call constructor of Novel */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("village_interfaces.msg._novel");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Novel");
