...
#include "village_interfaces/srv/detail/borrow_money__rosidl_typesupport_fastrtps_cpp.hpp"
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_village_interfaces
max_serialized_size_BorrowMoney_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  auto typed_message =
    static_cast<const village_interfaces::srv::BorrowMoney_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<village_interfaces::srv::BorrowMoney_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _BorrowMoney_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const village_interfaces::srv::BorrowMoney_Request *>(
...
{
  return max_serialized_size_BorrowMoney_Request(full_bounded, 0);
}
...
{
  return &village_interfaces::srv::typesupport_fastrtps_cpp::_BorrowMoney_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, village_interfaces, srv, BorrowMoney_Request)() {
  return &village_interfaces::srv::typesupport_fastrtps_cpp::_BorrowMoney_Request__handle;
}
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_village_interfaces
max_serialized_size_BorrowMoney_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  auto typed_message =
    static_cast<const village_interfaces::srv::BorrowMoney_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<village_interfaces::srv::BorrowMoney_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _BorrowMoney_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const village_interfaces::srv::BorrowMoney_Response *>(
...
{
  return max_serialized_size_BorrowMoney_Response(full_bounded, 0);
}
...
{
  return &village_interfaces::srv::typesupport_fastrtps_cpp::_BorrowMoney_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, village_interfaces, srv, BorrowMoney_Response)() {
  return &village_interfaces::srv::typesupport_fastrtps_cpp::_BorrowMoney_Response__handle;
}
...
{
  return &village_interfaces::srv::typesupport_fastrtps_cpp::_BorrowMoney__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, village_interfaces, srv, BorrowMoney)() {
  return &village_interfaces::srv::typesupport_fastrtps_cpp::_BorrowMoney__handle;
}
