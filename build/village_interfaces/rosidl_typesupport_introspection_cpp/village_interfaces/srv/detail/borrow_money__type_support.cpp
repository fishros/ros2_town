...
{
  new (message_memory) village_interfaces::srv::BorrowMoney_Request(_init);
}

void BorrowMoney_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<village_interfaces::srv::BorrowMoney_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember BorrowMoney_Request_message_member_array[2] = {
  {
    ...
    offsetof(village_interfaces::srv::BorrowMoney_Request, name),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(village_interfaces::srv::BorrowMoney_Request, money),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers BorrowMoney_Request_message_members = {
  ...
  2,  // number of fields
  sizeof(village_interfaces::srv::BorrowMoney_Request),
...
{
  return &::village_interfaces::srv::rosidl_typesupport_introspection_cpp::BorrowMoney_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, village_interfaces, srv, BorrowMoney_Request)() {
  return &::village_interfaces::srv::rosidl_typesupport_introspection_cpp::BorrowMoney_Request_message_type_support_handle;
}
...
void BorrowMoney_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) village_interfaces::srv::BorrowMoney_Response(_init);
}

void BorrowMoney_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<village_interfaces::srv::BorrowMoney_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember BorrowMoney_Response_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(village_interfaces::srv::BorrowMoney_Response, success),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(village_interfaces::srv::BorrowMoney_Response, money),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers BorrowMoney_Response_message_members = {
  ...
  2,  // number of fields
  sizeof(village_interfaces::srv::BorrowMoney_Response),
...
{
  return &::village_interfaces::srv::rosidl_typesupport_introspection_cpp::BorrowMoney_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, village_interfaces, srv, BorrowMoney_Response)() {
  return &::village_interfaces::srv::rosidl_typesupport_introspection_cpp::BorrowMoney_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers BorrowMoney_service_members = {
  ...
  // see get_service_type_support_handle<village_interfaces::srv::BorrowMoney>()
...
get_service_type_support_handle<village_interfaces::srv::BorrowMoney>()
{
  ...
  auto service_type_support =
    &::village_interfaces::srv::rosidl_typesupport_introspection_cpp::BorrowMoney_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, village_interfaces, srv, BorrowMoney)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<village_interfaces::srv::BorrowMoney>();
}
